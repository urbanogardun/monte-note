...
const notebookManager_1 = require("./src/utils/notebook-management/notebookManager");
const index_1 = require("./src/constants/index");
const dbMessager_1 = require("./src/utils/dbMessager");
...
electron_1.ipcMain.on(index_1.CHOOSE_LOCATION_FOR_NOTEBOOKS, (event, args) => {
    ...
    try {
        ...
        event.sender.send(index_1.LOAD_NOTEBOOKS_LOCATION, `${index_1.NOTEBOOKS_LOCATION_NOT_SET}_${Date.now()}`);
    }
    if (location) {
